...
function Get-SingleHbmXml
{
    ...
    Process
    {
        ...
        if([NoFuture.Hbm.Sorting]::AllStoredProcNames -contains $DbObjectName){
            ...
            [NoFuture.Hbm.Mapping]::StoredProcManager.GetSpResultSetXsd($searchCrit, ([NoFuture.Shared.Constants]::SqlServerDotNetConnString))
...
function Make-HbmAppConfig
{
    ...
    Process
    {
		...
		$hibernateconfiguration = [NoFuture.Hbm.XeFactory]::HibernateConfigurationNode(([NoFuture.Shared.Constants]::SqlServerDotNetConnString), 
																						$OutputNamespace)
...
function Get-HbmDb
{
    ...
    Process
    {
        ...
        if([System.String]::IsNullOrWhiteSpace([NoFuture.Shared.Constants]::SqlServer)){Write-Host "set the MSSQL server global variables."; break;}
        if([System.String]::IsNullOrWhiteSpace([NoFuture.Shared.Constants]::SqlCatalog)){Write-Host "set the MSSQL server global variables."; break;}
