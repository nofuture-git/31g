namespace NoFuture.Rand.Data.Exo.UsGov.Bls
{
    ...
    {
        public const string ApiSignature = "https://www.bls.gov/developers/api_signature_v2.htm";

        public static string PostUrl = "https://api.bls.gov/publicAPI/v2/timeseries/data/";
