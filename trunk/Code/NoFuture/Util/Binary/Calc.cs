namespace NoFuture.Util.Binary
{
    public class Calc
    {
        ...
        /// <summary>
        /// Calculates the length, in number of characters, that will be needed to convert the 
        /// given byte array length to a base64 char array.
        /// </summary>
        /// <param name="byteArrayLength">
        /// The length of the byte array that will be passed to a Base64 Convertor.
        /// </param>
        ...
        /// <summary>
        /// Calculates the length, in the number of bytes, that will be needed to decode 
        /// the given base64 length back to a byte array.
        /// </summary>
        /// <param name="base64StringLength">
        /// The length, in the number of chars, of the given base64 string.
        /// </param>
        /// <returns>
        /// Upon receiving the value '0' the value is incalculable and the string is probably not base64.
        /// </returns>
