...
namespace AdventureWorks.Sales
{
    ...
    {
        #region Id
        public virtual AdventureWorks.Sales.CountryRegionCurrencyCompositeId Id { get; set; }
        #endregion

        #region RequiredOverrides

		public virtual bool Equals(CountryRegionCurrency other)
        {
		...
		public override bool Equals(object obj)
        {
			...
			return obj.GetType() == typeof (CountryRegionCurrency) && Equals((CountryRegionCurrency) obj);
        }
