...
namespace AdventureWorks.Sales
{
    ...
    {
        #region Id
        public virtual AdventureWorks.Sales.PersonCreditCardCompositeId Id { get; set; }
        #endregion

        #region RequiredOverrides

		public virtual bool Equals(PersonCreditCard other)
        {
		...
		public override bool Equals(object obj)
        {
			...
			return obj.GetType() == typeof (PersonCreditCard) && Equals((PersonCreditCard) obj);
        }
