...
namespace AdventureWorks.Person
{
    ...
    {
        #region Id
        public virtual AdventureWorks.Person.PersonPhoneCompositeId Id { get; set; }
        #endregion

        #region RequiredOverrides

		public virtual bool Equals(PersonPhone other)
        {
		...
		public override bool Equals(object obj)
        {
			...
			return obj.GetType() == typeof (PersonPhone) && Equals((PersonPhone) obj);
        }
