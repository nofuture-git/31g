...
namespace AdventureWorks.Person
{
    ...
    {
        #region Id
        public virtual AdventureWorks.Person.BusinessEntityAddressCompositeId Id { get; set; }
        #endregion

        #region RequiredOverrides

		public virtual bool Equals(BusinessEntityAddress other)
        {
		...
		public override bool Equals(object obj)
        {
			...
			return obj.GetType() == typeof (BusinessEntityAddress) && Equals((BusinessEntityAddress) obj);
        }
