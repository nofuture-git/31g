...
namespace AdventureWorks.Production
{
    ...
    public class TransactionHistoryArchive
    {
		...
		public virtual bool Equals(TransactionHistoryArchive other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof (TransactionHistoryArchive)) return false;
            return this.Equals((TransactionHistoryArchive) obj);
        }
