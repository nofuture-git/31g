...
namespace AdventureWorks.HumanResources
{
    ...
    {
        #region Id
        public virtual AdventureWorks.HumanResources.EmployeeDepartmentHistoryCompositeId Id { get; set; }
        #endregion

        #region RequiredOverrides

		public virtual bool Equals(EmployeeDepartmentHistory other)
        {
		...
		public override bool Equals(object obj)
        {
			...
			return obj.GetType() == typeof (EmployeeDepartmentHistory) && Equals((EmployeeDepartmentHistory) obj);
        }
