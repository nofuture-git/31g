...
class TestNfConfig(unittest.TestCase):
    ...
    testDict = {
	    ...
	    "javaAntlrTool" : "$(binRootDir)\\antlr-4.7.1-complete.jar",
	    ...
	    "customInvokeAssemblyAnalysisTool" : "$(binRootDir)\\NoFuture.Util.DotNetMeta.InvokeAssemblyAnalysis.exe",
	    ...
	    "customInvokeDpxTool" : "$(binRootDir)\\NoFuture.Util.DotNetMeta.InvokeDpx.exe",
